...
class Libreria:
    def _init_(self, nombre, sección, editorial,año):
        self.nombre =nombre
...
class Rosalia(Libreria):
    def result():
        ...
        libro1= ("Oceanarium", "Ciencia", "Impedimenta", 2021)
        libro2= ("Botones", "Novela negra" , "Atlantis", 2022 )
        libro3= ("Venganza Compostela", "Historia", "Universo letras", 2022)


print(Libreria.metodo1)
